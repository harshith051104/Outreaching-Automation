      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(167,139,250,0.7)', margin: 0 }}>
            Create an account to start scaling your outreach
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#f5f3ff', margin: '0 0 6px' }}>Create Account</h2>
          <p style={{ fontSize: '13px', color: 'rgba(167,139,250,0.7)', margin: '0 0 24px' }}>Fill in your details to get started</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <User size={15} color="rgba(167,139,250,0.5)" style={{ position: 'absolute', left: '13px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
                <input
                  type="text"
                  value={name}
